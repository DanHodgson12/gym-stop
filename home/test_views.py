...
class HomeViewsTests(TestCase):
    ...
    def test_index_view(self):
        """
        Test that the index view returns a 200
    ...
    def test_privacy_policy_view(self):
        """
        Test that the privacy policy view returns a 200
        status code and uses the correct template.
        """
    ...
    def test_terms_and_conditions_view(self):
        """
        Test that the terms and conditions view returns a 200
        status code and uses the correct template.
        """
    ...
    def test_returns_policy_view(self):
        """
        Test that the returns policy view returns a 200
        status code and uses the correct template.
        """
    ...
    def test_page_not_found_view(self):
        """
        Test that the page not found view returns a 404
        status code and uses the correct template.
        """
